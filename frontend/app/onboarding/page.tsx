...
export default function Page(){
  ...
  return (<div className="mx-auto max-w-2xl space-y-4 py-6"><div className="hud-line" aria-hidden />
    <Card className="bento border-[var(--cor-borda)] bg-[var(--cor-fundo-card)]"><CardHeader><CardTitle>Onboarding</CardTitle><CardDescription className="text-[var(--cor-texto-suave)]">Escolha interesses e sua localidade</CardDescription></CardHeader><CardContent className="space-y-4">
      ...
      <div className="flex gap-2 text-xs text-[var(--cor-texto-suave)]"><Badge variant="outline" className="border-[var(--cor-borda)]">{sel.length} interesses</Badge></div>
