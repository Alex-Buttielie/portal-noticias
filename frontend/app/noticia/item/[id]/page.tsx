...
import { obterDetalheItem, type FeedDetalhe } from "@/lib/api";
...
async function getD(id:string): Promise<FeedDetalhe>{ try{ return await obterDetalheItem(id);}catch{ return {tipo:"item",id:Number(id)||1,titulo:`Item #${id} (mock)`,categoria:"geral",urgente:false,timestamp:new Date().toISOString(),fontes:[{nome_fonte:"Fonte Exemplo",url_fonte_original:"https://example.com",resumo:"Resumo mock - API offline"}],exibir_publicidade:false}; } }
