...
export default function Page() {
  return (
    <div className="mx-auto max-w-3xl space-y-4">
      <div className="rounded-[var(--raio-lg)] border border-[var(--cor-borda)] bg-[var(--cor-fundo-card)] p-6"><div className="hud-line mb-4" aria-hidden /><h1 className="text-2xl font-bold text-[var(--cor-texto)]">Termos de uso</h1><p className="text-sm text-[var(--cor-texto-suave)]">Última atualização: {new Date().toLocaleDateString("pt-BR")}</p></div>
