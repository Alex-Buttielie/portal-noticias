...
const MOCK: FeedEntrada[] = [
  { tipo: "cluster", id: 11, titulo: "Ao vivo: atualização contínua — API offline (mock)", resumo: "Fallback para não quebrar build.", categoria: "geral", urgente: true, numero_fontes: 3, timestamp: new Date().toISOString() },
