...
export default function Page(){
  ...
  return (<div className="mx-auto max-w-2xl space-y-4 py-6"><div className="hud-line" aria-hidden />
    <Card className="bento border-[var(--cor-borda)] bg-[var(--cor-fundo-card)]"><CardHeader><CardTitle>Status do credenciamento</CardTitle><CardDescription className="text-[var(--cor-texto-suave)]">HUD bento - vidro</CardDescription></CardHeader><CardContent className="space-y-4">
