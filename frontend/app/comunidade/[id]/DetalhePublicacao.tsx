...
// React 19, e o projeto está em React 18.3.1 (`next@15.5.26` aceita 18.2+),
// então a chamada seria `undefined` em runtime e a página cairia no fallback
// `safeId = 1`. Se um dia o projeto subir para o React 19, este arquivo pode
// voltar a ler `params` com `use()` — o wrapper em `./page.tsx` é o que
// garante o contrato.
export function DetalhePublicacao({ id: idParam }: { id: string }) {
