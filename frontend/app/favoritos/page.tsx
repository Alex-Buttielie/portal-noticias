...
export default function Page(){
  ...
  return (<div className="mx-auto max-w-3xl space-y-4 py-6"><div className="hud-line" aria-hidden />
    <Card className="bento border-[var(--cor-borda)] bg-[var(--cor-fundo-card)]"><CardHeader><CardTitle>Favoritos</CardTitle><CardDescription className="text-[var(--cor-texto-suave)]">Salvos localmente via lib/bookmarks.ts - HUD bento</CardDescription></CardHeader><CardContent>
