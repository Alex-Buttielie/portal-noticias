...
function RedefinirForm(){
  ...
  return (<Card className="bento border-[var(--cor-borda)] bg-[var(--cor-fundo-card)]"><CardHeader><CardTitle>Redefinir senha</CardTitle><CardDescription className="text-[var(--cor-texto-suave)]">HUD bento - vidro</CardDescription></CardHeader><CardContent>
