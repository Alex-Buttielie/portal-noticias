...
const FormField = <T extends FieldValues, N extends FieldPath<T>>({ ...props }: ControllerProps<T, N>) => (
...
const FormLabel = React.forwardRef<React.ElementRef<typeof Label>, React.ComponentPropsWithoutRef<typeof Label>>(({ className, ...props }, ref) => {
  ...
  return <Label ref={ref} className={cn(error && "text-[var(--cor-erro)]", className)} htmlFor={formItemId} {...props} />
})
...
const FormDescription = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(({ className, ...props }, ref) => {
  ...
  return <p ref={ref} id={formDescriptionId} className={cn("text-xs text-[var(--cor-texto-suave)]", className)} {...props} />
})
...
const FormMessage = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(({ className, children, ...props }, ref) => {
  ...
  if (!body) return null
  return <p ref={ref} id={formMessageId} className={cn("text-xs font-medium text-[var(--cor-erro)]", className)} {...props}>{body}</p>
})
